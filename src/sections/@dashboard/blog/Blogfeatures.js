...
export default function Blogfeatures({ post }) {
  ...
  const imagesLightbox = post.images.map((_image) => _image);
    ...
    <RootStyle>
      ...
      <Box
        sx={{
          ...
          ...(post.images.length === 1 && { maxWidth: THUMB_SIZE * 1 + 16 }),
          ...(post.images.length === 2 && { maxWidth: THUMB_SIZE * 2 + 32 }),
          ...(post.images.length === 3 && { maxWidth: THUMB_SIZE * 3 + 48 }),
          ...(post.images.length === 4 && { maxWidth: THUMB_SIZE * 3 + 48 }),
          ...(post.images.length >= 5 && { maxWidth: THUMB_SIZE * 6 }),
