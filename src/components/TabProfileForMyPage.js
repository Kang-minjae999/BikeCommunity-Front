...
import { Typography, BottomNavigation, BottomNavigationAction, Grid } from '@mui/material';
...
TabProfileForMyPage.propTypes = {
  TABS: PropTypes.array.isRequired,
  path: PropTypes.string.isRequired,
  Featured: PropTypes.node,
};

export default function TabProfileForMyPage({TABS, Featured, path}) {
